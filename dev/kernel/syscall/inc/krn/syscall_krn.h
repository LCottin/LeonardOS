...
typedef enum
{
    ...
    SYSCALL_PRINT_CHAR,         /* System call to print a char */
    ...
    SYSCALL_CONSOLE_GET,        /* System call to get console oldest char */
    SYSCALL_EXECUTE_CMD,        /* System call to execute a command */
...
static inline void syscall_handler_svc(syscall_request_t *request)
{
    register syscall_request_t *r0 __asm__("x0") = request;
    __asm__ volatile("svc #0" : : "r"(r0) : "memory", "cc");
}
