#ifndef __MMIO_IO32_READ_TC_H__
#define __MMIO_IO32_READ_TC_H__
...
{
    const char_t             *name;
    mmio_io32_read_input_t    input;
    mmio_io32_read_output_t   expected;
 ...
 ******************************************************************/
extern const mmio_io32_read_tc_t test_list[];
