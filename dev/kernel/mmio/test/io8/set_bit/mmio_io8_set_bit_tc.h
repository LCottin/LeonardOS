#ifndef __MMIO_IO8_SET_BIT_TC_H__
#define __MMIO_IO8_SET_BIT_TC_H__
 ...
 ******************************************************************/
#define K_MMIO_IO8_SET_BIT_NB_BITS_MAX 8
...
typedef struct
{
    ...
    uint8_t bit_index_to_set[K_MMIO_IO8_SET_BIT_NB_BITS_MAX];       /* Bit indexes to set in the buffer */
} mmio_io8_set_bit_input_t;
...
{
    const char_t                  *name;
    mmio_io8_set_bit_input_t       input;
    mmio_io8_set_bit_output_t      expected;
    byte_t                         reserved[5];   /* Reserved for future use */
} mmio_io8_set_bit_tc_t;
 ...
 ******************************************************************/
extern const mmio_io8_set_bit_tc_t   test_list[];
extern const spec_run_suite_t        test_suite;


#endif /* __MMIO_IO8_SET_BIT_TC_H__ */
