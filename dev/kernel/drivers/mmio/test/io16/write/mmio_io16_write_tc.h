#ifndef __MMIO_IO16_WRITE_TC_H__
#define __MMIO_IO16_WRITE_TC_H__
...
{
    const char_t              *name;
    mmio_io16_write_input_t    input;
    mmio_io16_write_output_t   expected;
    byte_t                     reserved[2];   /* Reserved for future use */
} mmio_io16_write_tc_t;
 ...
 ******************************************************************/
extern const mmio_io16_write_tc_t test_list[];
