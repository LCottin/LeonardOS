#ifndef __MMIO_IO64_READ_TC_H__
#define __MMIO_IO64_READ_TC_H__
...
{
    const char_t             *name;
    mmio_io64_read_input_t    input;
    mmio_io64_read_output_t   expected;
} mmio_io64_read_tc_t;
 ...
 ******************************************************************/
extern const mmio_io64_read_tc_t test_list[];
