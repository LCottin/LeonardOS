#ifndef __MMIO_IO16_KRN_H__
#define __MMIO_IO16_KRN_H__
 ...
 * @param bit The bit position (0-15) to set.
 *
 ...
 *
 * @param addr The memory address of the I/O register.
 * @param bit The bit position (0-15) to clear.
 *
 * @return This function does not return a value.
 **********************************************************************/
 ...
 *
 * @param addr The memory address of the I/O register.
 * @param bit The bit position (0-15) to toggle.
 *
 * @return This function does not return a value.
 **********************************************************************/
