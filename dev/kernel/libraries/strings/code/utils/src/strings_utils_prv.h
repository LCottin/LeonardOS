 ...
 **********************************************************************/
extern size_t strings_utils_get_base_prefix(const strings_utils_base_t base, char_t *prefix_buf);
 ...
 **********************************************************************/
extern size_t strings_utils_utoa_raw(const strings_utils_base_t base, const uint64_t value, char_t *str);
