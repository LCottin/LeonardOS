...
void pcb_init()
{
    ...
    g_pcb_ctx_table.pcb_krn_ctx.registers.elr_el1  = bmt_info_get_kernel_entry();
    g_pcb_ctx_table.pcb_krn_ctx.registers.spsr_el1 = K_PCB_INIT_SPSR_EL1_VALUE;
    ...
    for (uint32_t idx = 0; idx < g_pcb_ctx_table.pcb_apps_count; idx++)
    {
        ...
        g_pcb_ctx_table.pcb_apps_ctx[idx].registers.elr_el1  = bmt_info_get_app_entry(idx);
        g_pcb_ctx_table.pcb_apps_ctx[idx].registers.spsr_el1 = K_PCB_INIT_SPSR_EL1_VALUE;
    }
