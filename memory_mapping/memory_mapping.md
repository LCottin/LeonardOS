...
|------------------------|-----------------|----------------|--------------|------------|-------------|--------------------------------------|
| MMU kernel EL0         | global variable |                |              |            |             | Root page table for kernel EL0       |
|                        |                 | MMU kernel EL0 | 0x4f060000   | 0x00010000 | 0x4f06ffff  |   Root page table for kernel EL0     |
|------------------------|-----------------|----------------|--------------|------------|-------------|--------------------------------------|
| MMU                    | global variable |                |              |            |             | Memory Management Unit               |
|                        |                 | MMU            | 0x4f080000   | 0x00100000 | 0x4f17ffff  |   Memory Management Unit Address     |
|------------------------|-----------------|----------------|--------------|------------|-------------|--------------------------------------|
